# Define the Python script you want to run (main.py in this case)
$pythonScript = "main.py"

# Define the function you want to execute (e.g., "generate_excel_files", "separate_files", or "train_translations")
$functionName = $args[0]
